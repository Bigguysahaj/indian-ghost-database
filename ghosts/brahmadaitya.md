...
ID: `brahmadaitya` · Research status: **initial_notes**

Listed in Riksundar Banerjee’s *The Book of Indian Ghosts*, entry 9, chapter starts on page 29 in the photographed edition. Only the contents entry was supplied; this is not evidence for the lore below.

Proposed search aliases (equivalence needs review): Brahmodaitya

| Field | Research note | Evidence status |
| --- | --- | --- |
| Classification | Unknown — research needed.  | unknown |
| Description | Brahmin ghost, often helpful in Bengali tales. [bengal](https://en.wikipedia.org/wiki/Ghosts_in_Bengali_culture) | provisional |
